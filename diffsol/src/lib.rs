...
#[cfg(feature = "faer")]
pub use linear_solver::{faer::sparse_lu::FaerSparseLU, FaerLU};
pub use linear_solver::NalgebraLU;

#[cfg(feature = "faer")]
pub use context::faer::FaerContext;
pub use context::{nalgebra::NalgebraContext, Context};
...
#[cfg(feature = "faer")]
pub use matrix::{dense_faer_serial::FaerMat, sparse_faer::FaerSparseMat};
pub use matrix::{
    default_solver::DefaultSolver, dense_nalgebra_serial::NalgebraMat,
    DenseMatrix, Matrix, MatrixCommon,
};
...
#[cfg(feature = "faer")]
pub use vector::faer_serial::{FaerVec, FaerVecIndex, FaerVecMut, FaerVecRef};
pub use vector::{
